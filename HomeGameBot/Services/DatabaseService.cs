...
internal sealed class DatabaseService : BackgroundService
{
    ...
    private readonly IDbContextFactory<HomeGameContext> _dbContextFactory;
    ...
    public DatabaseService(ILogger<DatabaseService> logger, IDbContextFactory<HomeGameContext> dbContextFactory)
    {
        _logger = logger;
